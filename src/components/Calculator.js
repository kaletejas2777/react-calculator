    ...
    <div className="calculator">
      ...
      <div className="calculator-keypad">
        <div className="keys-function">
          <CalculatorKey className="style" keyValue={"c"} onClick={handleOperation} />
          <CalculatorKey className="style" keyValue={"\xB1"} onClick={handleOperation} />
          <CalculatorKey className="style" keyValue={"%"} onClick={handleOperation} />
        </div>
        <div className="keys-operators">
          <CalculatorKey  className="opration" keyValue={"+"} onClick={handleOperation} />
          <CalculatorKey  className="opration" keyValue={"-"} onClick={handleOperation} />
          <CalculatorKey  className="opration" keyValue={"*"} onClick={handleOperation} />
          <CalculatorKey  className="opration" keyValue={"/"} onClick={handleOperation} />
